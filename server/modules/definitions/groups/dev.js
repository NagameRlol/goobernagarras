...
Class.nagbosses = menu("fuckin hell")
Class.nagbosses.REROOT_UPGRADE_TREE = "nagbosses"
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.priestmissile]),
                TYPE: "priestmissile",
            }
        }
    ]
...
Class.pray = {
    PARENT: "genericTank",
    LABEL: "Priest",
    NAME: "start praying o god",
    UPGRADE_TOOLTIP: "the start of the nag armada",
    COLOR: 6,
    UPGRADE_COLOR: 6,
    DANGER: 10,
    LEVEL: 45,
    SIZE: 35,
    SHAPE: "M 0.5 0.5 L 0 1 L -0.5 0.5 L -0.5 -0.5 L -0 -1 L 0.5 -0.5 L 0.5 0.5",
    VALUE: 500000,
    ...
    GUNS: [
        ...
        },
		{
			...
			PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.priest]),
                TYPE: "trap",
            }
        },
		//secondary stuff 2
	...
	TURRETS: [
		{
            POSITION: [3, 2, 0, 0, 130, 1],
            TYPE: "prayturret2"
        },
		{
            POSITION: [3, 2, 0, 180, 130, 1],
            TYPE: "prayturret2"
        },
        {
...
Class.developer.UPGRADES_TIER_0 = ["tanks", "bosses", "spectator", "levels", "teams", "eggGenerator", "testing", "addons", "nagbosses"]
	...
	Class.nagbosses.UPGRADES_TIER_0 = ["pray"]
